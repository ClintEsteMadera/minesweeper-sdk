...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Minesweeper2020.GamesApi();
  });
  ...
  describe('GamesApi', function() {
    ...
    describe('findGameById', function() {
      it('should call findGameById successfully', function(done) {
        //uncomment below and update the code to test findGameById
        //instance.findGameById(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
